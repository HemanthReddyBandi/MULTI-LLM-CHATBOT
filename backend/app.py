...
from backend.auth_module.router import router as auth_router
from backend.auth_module.database import engine
from backend.auth_module.models import Base
